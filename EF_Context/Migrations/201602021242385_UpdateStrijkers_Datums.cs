namespace EF_Context.Migrations
{
    ...
    public partial class UpdateStrijkers_Datums : DbMigration
    {
        public override void Up()
        {
            ...
            DropColumn("dbo.Datum", "Strijker_Id1");
            DropColumn("dbo.Datum", "Strijker_Id2");
            DropColumn("dbo.Datum", "Strijker_Id3");
            DropColumn("dbo.Datum", "Strijker_Id4");
        ...
        public override void Down()
        {
            ...
            AddColumn("dbo.Datum", "Strijker_Id4", c => c.Int());
            AddColumn("dbo.Datum", "Strijker_Id3", c => c.Int());
            AddColumn("dbo.Datum", "Strijker_Id2", c => c.Int());
            AddColumn("dbo.Datum", "Strijker_Id1", c => c.Int());
            ...
            CreateIndex("dbo.Datum", "Strijker_Id4");
            CreateIndex("dbo.Datum", "Strijker_Id3");
            CreateIndex("dbo.Datum", "Strijker_Id2");
            CreateIndex("dbo.Datum", "Strijker_Id1");
            ...
            AddForeignKey("dbo.Datum", "Strijker_Id4", "dbo.Strijkers", "Id");
            AddForeignKey("dbo.Datum", "Strijker_Id3", "dbo.Strijkers", "Id");
            AddForeignKey("dbo.Datum", "Strijker_Id2", "dbo.Strijkers", "Id");
            AddForeignKey("dbo.Datum", "Strijker_Id1", "dbo.Strijkers", "Id");
